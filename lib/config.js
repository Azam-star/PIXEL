...
const DEFAULTS = {
  ...
  loop: {
    ...
    maxStuckRepeats: 4,          // abort if the model repeats the same action with no page change this many times
    maxEmptyPlans: 5,            // reflect (then abort) after this many consecutive LLM turns with no tool action
